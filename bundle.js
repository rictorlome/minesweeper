...
var _game_component = __webpack_require__(25);

var _game_component2 = _interopRequireDefault(_game_component);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener("DOMContentLoaded", function () {
  var root = document.getElementById("root");
  _reactDom2.default.render(_react2.default.createElement(_game_component2.default, null), root);
});
...
var _logic = __webpack_require__(26);

var Minesweeper = _interopRequireWildcard(_logic);

var _board_component = __webpack_require__(27);
...
var Game = function (_React$Component) {
  ...
  _createClass(Game, [{
    key: 'updateGame',
    value: function updateGame(pos, flagging) {
      var i = pos[0];
      var j = pos[1];
...
var _tile_component = __webpack_require__(28);

var _tile_component2 = _interopRequireDefault(_tile_component);
...
var Board = function Board(props) {
  var update = props.updateGame;
  var grid = props.board.grid.map(function (row, i) {
    return _react2.default.createElement(
      'div',
      { key: i, className: 'row' },
